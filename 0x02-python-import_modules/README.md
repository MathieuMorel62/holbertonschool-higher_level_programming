...
mathieu@ubuntu:~/$ ./0-add.py
1 + 2 = 3

mathieu@ubuntu:~/$ cat 0-import_add.py
__import__("0-add")
```
</details>
...
```python
mathieu@ubuntu:~/$ cat calculator_1.py
...
mathieu@ubuntu:~/$ ./1-calculation.py
10 + 5 = 15
10 - 5 = 5
10 * 5 = 50
10 / 5 = 2
...
```python
mathieu@ubuntu:~/$ ./2-args.py 
0 arguments.

mathieu@ubuntu:~/$ ./2-args.py Hello
1 argument:
1: Hello

mathieu@ubuntu:~/$ ./2-args.py Hello Welcome To The Best School
6 arguments:
1: Hello
2: Welcome
3: To
...
```python
mathieu@ubuntu:~/$ ./3-infinite_add.py
0

mathieu@ubuntu:~/$ ./3-infinite_add.py 79 10
89

mathieu@ubuntu:~/$ ./3-infinite_add.py 79 10 -40 -300 89 
-162
```
</details>
...
```python
mathieu@ubuntu:~/$ curl -Lso "hidden_4.pyc" "https://github.com/hs-hq/0x02.py/raw/master/hidden_4.pyc"

mathieu@ubuntu:~/$ ./4-hidden_discovery.py | sort
my_secret_santa
print_hidden
print_school
```
...
```python
mathieu@ubuntu:~/$ cat variable_load_5.py
...
mathieu@ubuntu:~/$ ./5-variable_load.py
98
```
</details>
...
mathieu@ubuntu:~/$ ./100-my_calculator.py ; echo $?
Usage: ./100-my_calculator.py <a> <operator> <b>
1

mathieu@ubuntu:~/$ ./100-my_calculator.py 3 + 5 ; echo $?
3 + 5 = 8
0

mathieu@ubuntu:~/$ ./100-my_calculator.py 3 H 5 ; echo $?
...
```python
mathieu@ubuntu:~/$ ./101-easy_print.py
#pythoniscool
```
</details>
...
```python
mathieu@ubuntu:~/$ ./103-fast_alphabet.py
ABCDEFGHIJKLMNOPQRSTUVWXYZ

mathieu@ubuntu:~/$ wc -l 103-fast_alphabet.py
