...
```sql
mathieu@ubuntu:~/$ cat 0-select_states.sql
...
mathieu@ubuntu:~/$ cat 0-select_states.sql | mysql -uroot -p
Enter password: 
...
mathieu@ubuntu:~/$ cat 0-select_states.sql | mysql -uroot -p
Enter password: 
mathieu@ubuntu:~/$ ./1-filter_states.py root root hbtn_0e_0_usa
...
mathieu@ubuntu:~/$ cat 0-select_states.sql | mysql -uroot -p
Enter password: 
mathieu@ubuntu:~/$ ./2-my_filter_states.py root root hbtn_0e_0_usa 'Arizona'
...
mathieu@ubuntu:~/$ cat 0-select_states.sql | mysql -uroot -p
Enter password: 
mathieu@ubuntu:~/$ ./3-my_safe_filter_states.py root root hbtn_0e_0_usa 'Arizona'
...
```sql
mathieu@ubuntu:~/$ cat 4-cities_by_state.sql
...
mathieu@ubuntu:~/$ cat 4-cities_by_state.sql | mysql -uroot -p
Enter password: 
mathieu@ubuntu:~/$ ./4-cities_by_state.py root root hbtn_0e_4_usa
...
mathieu@ubuntu:~/$ ./5-filter_cities.py root root hbtn_0e_4_usa Texas
mathieu@ubuntu:~/$ cat 4-cities_by_state.sql | mysql -uroot -p
Enter password: 
mathieu@ubuntu:~/$ ./5-filter_cities.py root root hbtn_0e_4_usa Texas
...
mathieu@ubuntu:~/$ ./5-filter_cities.py root root hbtn_0e_4_usa Hawaii
...
```python
mathieu@ubuntu:~/$ cat 6-model_state.sql
...
mathieu@ubuntu:~/$ cat 6-model_state.sql | mysql -uroot -p
Enter password: 
  
ERROR 1146 (42S02) at line 4: Table 'hbtn_0e_6_usa.states' doesn't exist

  
mathieu@ubuntu:~/$ cat 6-model_state.py
...
mathieu@ubuntu:~/$ ./6-model_state.py root root hbtn_0e_6_usa
mathieu@ubuntu:~/$ cat 6-model_state.sql | mysql -uroot -p
Enter password: 
...
```sql
mathieu@ubuntu:~/$ cat 7-model_state_fetch_all.sql
  
-- Insert states
INSERT INTO states (name) VALUES ("California"), ("Arizona"), ("Texas"), ("New York"), ("Nevada");

mathieu@ubuntu:~/$ cat 7-model_state_fetch_all.sql | mysql -uroot -p hbtn_0e_6_usa
Enter password: 
mathieu@ubuntu:~/$ ./7-model_state_fetch_all.py root root hbtn_0e_6_usa
...
```sql
mathieu@ubuntu:~/$ ./8-model_state_fetch_first.py root root hbtn_0e_6_usa
...
```sql
mathieu@ubuntu:~/$ ./9-model_state_filter_a.py root root hbtn_0e_6_usa
...
```sql
mathieu@ubuntu:~/$ ./10-model_state_my_get.py root root hbtn_0e_6_usa Texas
  
3
  
mathieu@ubuntu:~/$ ./10-model_state_my_get.py root root hbtn_0e_6_usa Illinois
...
```sql
mathieu@ubuntu:~/$ ./11-model_state_insert.py root root hbtn_0e_6_usa 
...
```sql
mathieu@ubuntu:~/$ ./12-model_state_update_id_2.py root root hbtn_0e_6_usa 
mathieu@ubuntu:~/$ ./7-model_state_fetch_all.py root root hbtn_0e_6_usa 
...
```sql
mathieu@ubuntu:~/$ ./13-model_state_delete_a.py root root hbtn_0e_6_usa 
mathieu@ubuntu:~/$ ./7-model_state_fetch_all.py root root hbtn_0e_6_usa 
...
```sql
mathieu@ubuntu:~/$ cat 14-model_city_fetch_by_state.sql
...
mathieu@ubuntu:~/$ cat 14-model_city_fetch_by_state.sql | mysql -uroot -p
Enter password: 
mathieu@ubuntu:~/$ ./14-model_city_fetch_by_state.py root root hbtn_0e_14_usa
...
```sql
mathieu@ubuntu:~/$ cat 100-relationship_states_cities.sql
...
mathieu@ubuntu:~/$ cat 100-relationship_states_cities.sql | mysql -uroot -p
Enter password: 
  
ERROR 1146 (42S02) at line 5: Table 'hbtn_0e_100_usa.states' doesn't exist

mathieu@ubuntu:~/$ ./100-relationship_states_cities.py root root hbtn_0e_100_usa
mathieu@ubuntu:~/$ cat 100-relationship_states_cities.sql | mysql -uroot -p
Enter password: 
...
```sql
mathieu@ubuntu:~/$ cat 101-relationship_states_cities_list.sql
...
mathieu@ubuntu:~/$ cat 101-relationship_states_cities_list.sql | mysql -uroot -p
mathieu@ubuntu:~/$ ./101-relationship_states_cities_list.py root root hbtn_0e_101_usa
...
```sql
mathieu@ubuntu:~/$ ./102-relationship_cities_states_list.py root root hbtn_0e_101_usa
